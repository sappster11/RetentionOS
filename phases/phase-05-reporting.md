...
**Why now:** by this phase we have real data flowing (clients, activity, tasks, Shopify/Klaviyo
analytics, campaigns/sends), so there's something worth measuring. Much of the retention signal
already lives in the Phase 3 analytics tables — this phase surfaces it and adds agency-ops metrics.

**Prerequisites:** Phases 1–4 (data to report on; Phase 3 analytics is the core retention substrate).
...
### 5.4 — Dashboards (fast path: Metabase)
...
### 5.5 — Dashboards (in-app, client-facing)
...
When all three work, Phase 5 is done.

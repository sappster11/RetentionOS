...
**Why now:** this is the most revenue-visible capability of a retention agency. By now the CRM (data)
and PM (workflow) exist to ground and operationalize the content.

**Prerequisites:** Phase 1 (CRM + RAG), Phase 2 (PM) complete.
...
### 3.4 — Delivery integrations (edges)
...
### 3.5 — Human-in-the-loop review UI
...
When all three work, Phase 3 is done.
